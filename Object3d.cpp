...
void Object3d::Update()
{
	...
	constMap1->ambient = model.GetMaterialAmbient();
	constMap1->diffuse = model.GetMaterialDiffuse();
	constMap1->specular = model.GetMaterialSpecular();
	constMap1->alpha = model.GetMaterialAlpha();
